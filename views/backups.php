								...
								<div class="isx-backup-dots-wrap">
									...
									<div class="isx-backup-dots-menu">
										<ul role="menu">
											...
											<li>
												<a tabindex="-1" href="<?php echo esc_url( admin_url( 'admin-ajax.php?action=isx_download&backup=' . rawurlencode( $isx_backup['name'] ) . '&nonce=' . wp_create_nonce( ISX_Admin::NONCE ) ) ); ?>" role="menuitem">
